...
Shared packages keep domain math, broker adapters, and persistence isolated. See `SPEC.md` for the product contract. Production packaging lives in `infra/docker/` (ADR-018).
